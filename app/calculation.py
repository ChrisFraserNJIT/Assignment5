...
class Calculation:
    ...
    #Required fields
    operation: str          # Name of the operation e.g Addition
    opperand1: Decimal      # First opperand in the calculation
    opperand2: Decimal      # Second opperand in the calculation

    # Fields with default values
    result: Decimal = field(init=False) # Result of the calculation, computed post-initialization
    timestamp: datetime.datetime = field(default_factory=datetime.datetime.now) # Time calculation was performed

    def __post_init__(self):

        #Calculates the result of the operation after the calculation
        self.result = self.calculate()

    def calculate(self) -> Decimal:

        # Execute calculation using specific operation
        # Mapping of operations names to their corresponding functions
        operations = {
